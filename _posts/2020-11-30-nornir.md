...
In Nornir, you can run tasks against a collection of devices that are organized in its inventory. Nornir is written in Pyton. And not only is Nornir written in Python, everything you do in Nornir is done in Python. This means that instead of working with a DSL, you express yourself in Python. 
