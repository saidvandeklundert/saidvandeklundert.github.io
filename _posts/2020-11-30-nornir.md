...
A major benefit is that you can work with everything that is available in the Python ecosystem. Most people using other frameworks tout the fact that it comes with 'batteries included'. Most often, these 'batteries' are the hard work of others. It is Python, brought to you by the open source community. In Nornir, you have access to many of the same batteries. Just pip install them and you are good to go.
