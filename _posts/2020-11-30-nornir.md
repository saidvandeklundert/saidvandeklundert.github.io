...
The sutasks run after the logging task do the following:
...
Plugins are installed separately. So before you can use the NAPALM plugin, it needs to be installed:
