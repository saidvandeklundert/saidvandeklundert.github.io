...
In the search for a framework that would allow me to plug my automations without too much fuss, I came accross <b>Nornir</b>. I have been enjoying it so much, that I decided to do write down an introduction for others. Hopefully, it will allow others to hit the ground running.
