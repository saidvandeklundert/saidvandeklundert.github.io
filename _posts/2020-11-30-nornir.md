...
The previous code runs the <b>main_task</b> against all the hosts in the inventory that are a member of the <b>arista_eapi</b> group. The main task is defined as follows:
