...
The 'about' section in the Nornir repo does a good job summarizing it. States is that Nornir is a 'pluggable multi-threaded framework with inventory management to help operate collections of devices'.
...
Organizing tasks in this way let's you create bigger programms that are still organized. Note that this is not the way you HAVE to do things in Nornir, it is just a way in which you COULD choose to do things in Nornir.
...
This time, we call a function to initialize the Nornir object:
