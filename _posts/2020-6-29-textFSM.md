...
Google TextFSM is a Python module that is written to make parsing text easier. It is a convenient way to turn CLI output into structured data. In this blog, I want to walkthrough a textFSM example and after that share the way in which I have been textFSM lately.
