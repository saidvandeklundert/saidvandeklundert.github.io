...
**Salt-master**: the Salt master service is what manages and orchestrates the remote systems. The master has a several constructs at its disposal to control the remote systems. Some of these constructs are the following (discussed later):
