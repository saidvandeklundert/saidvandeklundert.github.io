...
- you can use the standard library and, if the system the minion runs on will let you, pip install whatever you want
...
SaltStack has a lot of different parts to it. It is overwhelming at first, but really great to work with after you wrap your head around it. I sometimes distinguish between the core components of Salt that we put to work for us and the parts we use to interface with those core components. Let's summarize the article along these lines.
