...
SaltStack comes with its own set of terms and terminology and this can be a bit overwhelming at first. The following is picture that captures part of the architecture and displays a lot 'Saltspeak':
