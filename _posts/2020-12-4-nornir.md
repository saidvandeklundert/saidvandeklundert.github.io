...
It takes care of the inventory and let's you run tasks against devices, but it does not impose. It is lightweight and fast and does not require a lot of memory or CPU.
