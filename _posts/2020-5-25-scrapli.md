...
Scrapli can be found <a href="https://github.com/carlmontanari/scrapli" target="_blank">here</a>. The <b>README.md</b> is, in my opinion, pretty solid. It contains a good description of what Scrapli is and how you can put it to use. In case you consider using scrapli, I suggest you check it out. 
...
If you are normally using Paramiko (or netmiko) in the scripts where you are screen scraping, you can see things speed up quite a bit. Especially if your script touches many devices. The following is are 2 posts where the ssh2-python author compares paramiko with his own package:
